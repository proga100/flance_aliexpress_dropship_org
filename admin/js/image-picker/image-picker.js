  ...
  ImagePickerOption = (function() {
    function ImagePickerOption(option_element, picker, opts1) {
      ...
      this.clicked = bind(this.clicked, this);
	   this.clicked_add = bind(this.clicked_add, this); // featured image add function
    ...
    ImagePickerOption.prototype.clicked = function(event) {
	 ...
	 ImagePickerOption.prototype.clicked_add = function(event) { // function add featured image
    ...
    ImagePickerOption.prototype.create_node = function() {
      var image, imgAlt, imgClass, thumbnail, add_f;
      this.node = jQuery("<li/>");
	...
	//    add_f = jQuery("<div class='add_f'>");
		
	//  thumbnail.append(jQuery(add_f).html("aaa"));
	// add_f.on("click",  ""); // add featured image
